...
#define TRIPLE_COMBINED_NETVAR_FUNCTION(returnType, functionName, table1, name1, table2, name2, table3, name3)                                                             \
	returnType* functionName() {                                                                                                                     \
		return reinterpret_cast<returnType*>(reinterpret_cast<char*>(this) + Netvars::GetOffset(table1, name1) + Netvars::GetOffset(table2, name2) + Netvars::GetOffset(table3, name3)); \
	}
