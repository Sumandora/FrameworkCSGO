...
void Hooks::Game::Hook()
{
	...
	ViewDrawFade::hook = new class GameHook(SignatureScanner::FindNextOccurrence(SignatureScanner::BuildSignature(xorstr_("55 48 89 e5 41 57 49 89 D7 41 56 49 89 F6 41 55 41 54 41")), Memory::GetBaseAddress(xorstr_("engine_client.so"))), reinterpret_cast<void*>(ViewDrawFade::HookFunc));
}
