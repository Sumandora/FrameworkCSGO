#ifndef SDK_CLIENTCLASSIDS
#define SDK_CLIENTCLASSIDS

// Use https://github.com/cragson/CSGO-ClassID-Dump-Converter
// Added CAI_BaseNPC (0) for completeness

enum class ClientClassID : int {
	CAI_BaseNPC = 0,
	CAK47 = 1,
	CBaseAnimating = 2,
